...
@testset "geodesic" begin
    ...
    # MCPhyloTree.initialize_tree!(t3; height=false)
    # MCPhyloTree.initialize_tree!(t4; height=false)
    @test geodesic(t1, t2) == 3.2474428644835647
    # @test geodesic(t3, t4) == 2.844225
end
